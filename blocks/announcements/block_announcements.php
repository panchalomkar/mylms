...
class block_announcements extends block_base {
    ...
    public function get_content() {
        ...
        if (!isloggedin() or isguestuser()) {
            // Only real users can access announcements block.
            return;
        }

        $renderable = new \block_announcements\output\announcements($this->config);
        $renderer = $this->page->get_renderer('block_announcements');
