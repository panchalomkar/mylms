...
class ReviewManager {
    ...
    public function get_short_design_enrolmentpage($forid) {
        ...
        $html .= "<span class='small-info-regular avgratingstat'><b>$data->averagerating</b> ({$data->totalcount} ".get_string('enrolpagereviewstext', 'block_edwiserratingreview').")&nbsp;</span>";
