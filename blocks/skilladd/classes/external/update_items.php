...
use block_skilladd\event\task_complete;
use external_api;
...
/**
 * External function 'block_skilladd_update_items' implementation.
 *
...
class update_items extends external_api {
    ...
    public static function execute(int $instanceid, array $items) {
        ...
        foreach ($items as $item) {
            if ($record = $DB->get_record('block_skilladd_items',
                ...
                $DB->update_record('block_skilladd_items', $record, true);
                $itemsupdated++;
            }
        }
