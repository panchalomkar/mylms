...
require_once($CFG->dirroot.'//blocks/skilladd/backup/moodle2/backup_skilladd_stepslib.php');

/**
 * Provides all the settings and steps to perform a complete backup of block_skilladd.
 */
class backup_skilladd_block_task extends backup_block_task {
    ...
    protected function define_my_steps() {
        $this->add_step(new backup_skilladd_block_structure_step('skilladd', 'skilladd.xml'));
    }
