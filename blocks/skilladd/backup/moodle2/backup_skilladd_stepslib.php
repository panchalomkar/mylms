...
/**
 * Backup steps for block_skilladd are defined here.
 *
 ...
 */
class backup_skilladd_block_structure_step extends backup_block_structure_step {
    ...
    protected function define_structure() {
        ...
        $item->set_source_table('block_skilladd_items', ['instanceid' => backup::VAR_BLOCKID]);
