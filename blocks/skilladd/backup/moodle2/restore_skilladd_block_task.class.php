...
/**
 * The task that provides a complete restore of block_skilladd is defined here.
 *
...
require_once($CFG->dirroot.'//blocks/skilladd/backup/moodle2/restore_skilladd_stepslib.php');

/**
 * Restore task for block_skilladd.
 */
class restore_skilladd_block_task extends restore_block_task {
    ...
    protected function define_my_steps() {
        $this->add_step(new restore_skilladd_block_structure_step('skilladd', 'skilladd.xml'));
    }
