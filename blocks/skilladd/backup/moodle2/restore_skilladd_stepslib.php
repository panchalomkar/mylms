...
/**
 * All the steps to restore block_skilladd are defined here.
 *
 ...
 */
class restore_skilladd_block_structure_step extends restore_structure_step {
    ...
    public function process_block($data) {
        ...
        foreach ($data->items[0]['item'] as $item) {
            ...
            $DB->insert_record('block_skilladd_items', $item);
        }
    }
}
