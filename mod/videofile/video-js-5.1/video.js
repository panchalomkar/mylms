  ...
  Player.prototype.usingNativeControls = function usingNativeControls(bool) {
    if (bool !== undefined) {
      ...
      if (this.usingNativeControls_ !== bool) {
        ...
        if (bool) {
          /** @desc:- #1074 Video Player IPAD Issue */
...
var Html5 = (function (_Tech) {
  ...
  function Html5(options, ready) {
    ...
    if (browser.TOUCH_ENABLED && options.nativeControlsForTouch === true || browser.IS_IPHONE || browser.IS_IPAD || browser.IS_NATIVE_ANDROID) {
