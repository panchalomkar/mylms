...
$string['alreadysignedup'] = 'You have already signed-up for this ILT activity.';
...
$string['calendareventdescriptionbooking'] = 'You are booked for this <a href="{$a}">ILT session</a>.';
$string['calendareventdescriptionsession'] = 'You have created this <a href="{$a}">ILT session</a>.';
...
$string['crontask'] = 'ILT maintenance jobs';
...
$string['error:addalreadysignedupattendee'] = '{$a} is already signed-up for this ILT activity.';
...
$string['error:couldnotaddtrainer'] = 'Could not save new ILT session trainer';
...
$string['error:couldnotdeletetrainer'] = 'Could not delete a ILT session trainer';
...
$string['error:couldnotupdateILTrecord'] = 'Could not update ILT signup record in database';
...
$string['error:ILTfailedupdatestatus'] = 'ILT failed to update the user\'s status';
...
$string['error:incorrectcoursemodulesession'] = 'Course Module ILT Session was incorrect';
$string['error:incorrectiltid'] = 'ILT ID was incorrect';
...
$string['error:mustspecifycoursemoduleilt'] = 'Must specify a course module or a ILT ID';
...
$string['error:nopermissiontosignup'] = 'You don\'t have permission to signup to this ILT session.';
...
$string['error:sessionstartafterend'] = 'Session start date/time is greater than finish date/time.';
$string['error:signedupinothersession'] = 'You are already signed up in another session for this activity. You can only sign up for one session per ILT activity.';
 ...
 */
$string['ilt'] = 'ILT';
$string['ilt:addinstance'] = 'Add instance';
$string['ilt:addattendees'] = 'Add attendees to a ILT session';
$string['ilt:configurecancellation'] = 'Allow the configuration of sign-up cancellations, upon adding/editing a face-to-face activity.';
$string['ilt:editsessions'] = 'Add, edit, copy and delete ILT sessions';
$string['ilt:overbook'] = 'Sign-up to full sessions.';
$string['ilt:removeattendees'] = 'Remove attendees from a ILT session';
$string['ilt:signup'] = 'Sign-up for a session';
$string['ilt:takeattendance'] = 'Take attendance';
$string['ilt:view'] = 'View ILT activities and sessions';
$string['ilt:viewattendees'] = 'View attendance list and attendees';
$string['ilt:viewcancellations'] = 'View cancellations';
$string['ilt:viewemptyactivities'] = 'View empty ILT activities';
$string['iltbooking'] = 'ILT booking';
$string['iltname'] = 'ILT name';
$string['iltsession'] = 'ILT session';
$string['iltcourseusers'] = 'Course Users';
$string['iltallusers'] = 'All Users';
$string['iltfilters'] = 'Filters';
$string['placeholder:location'] = '[location]';
$string['placeholder:classroom'] = '[classroom]';
//End ILT strings
...
$string['noilts'] = 'There are no ILT activities';
...
$string['noupcoming'] = '<p>No upcoming sessions</p>';
...
$string['pluginadministration'] = 'ILT administration';
$string['pluginname'] = 'ILT';
$string['points'] = 'Points';
$string['pointsplural'] = 'Points';
$string['previoussessions'] = 'Previous sessions';
$string['previoussessionslist'] = 'List of all past sessions for this ILT activity';
$string['printversionid'] = 'Print version: without name';
$string['printversionname'] = 'Print version: with name';
$string['privacy:metadata:ilt_signups'] = 'User signups to Face-to-face sessions';
$string['privacy:metadata:ilt_signups:id'] = 'The id of the signup';
$string['privacy:metadata:ilt_signups:sessionid'] = 'The session id';
$string['privacy:metadata:ilt_signups:mailedreminder'] = 'The time a reminder was last sent';
$string['privacy:metadata:ilt_signups:discountcode'] = 'The discount code entered by the user';
$string['privacy:metadata:ilt_signups:notificationtype'] = 'How the user would like to be notified.';
$string['privacy:metadata:ilt_signups_status'] = 'The Status of a user signup to a session';
$string['privacy:metadata:ilt_signups_status:signupid'] = 'The id of the signup';
$string['privacy:metadata:ilt_signups_status:statuscode'] = 'The status of the signup eg cancelled,declined,fully_attended';
$string['privacy:metadata:ilt_signups_status:grade'] = 'The grade assigned for attending the session';
$string['privacy:metadata:ilt_signups_status:note'] = 'Stores the reason for a cancelled session';
$string['privacy:metadata:ilt_signups_status:timecreated'] = 'The time the signup was created.';
$string['privacy:metadata:ilt_session_roles'] = 'Lists users with a trainer role in a ilt session';
$string['privacy:metadata:userid'] = 'The ID of the user who accessed the ILT activity';
$string['privacy:metadata:roleid'] = 'The role ID of the user.';
$string['really'] = 'Do you really want to delete all results for this ILT?';
...
/*
* @Author VaibhavG 
* @desc added string session instructor on 11Dec2018
*/
$string['sessioninstructor'] = 'Instructor';
$string['sessioninstructors'] = 'Instructor(s)';
$string['sessioninstructorsform'] = 'Select Instructor(s)';
$string['sessioninstructornone'] = 'Please, Enroll the Session Instructor.';
$string['sessclassroom'] = 'Classroom';
$string['sessioncostcenter'] = 'Cost Center';
$string['sessionlocationnone'] = 'No Location Found.';
$string['sessionclassroomnone'] = 'No Classroom Found.';
$string['sessionlocationdefault'] = 'Select Location.';
$string['sessionname'] = 'Session Name.';
$string['sessionresource'] = 'Resource.';
$string['sessionresources'] = 'Select Resource(s)';
$string['error:sessionover'] = 'Session Over Book. Please, book the users as per session capacity.';
$string['sessionalertinstructor'] = 'Already enrolled to other session';
...
$string['setting:defaultconfirmationsubjectdefault'] = 'Course booking confirmation: [iltname], [starttime]-[finishtime], [sessiondate]';
...
$string['setting:defaultremindersubjectdefault'] = 'Course booking reminder: [iltname], [starttime]-[finishtime], [sessiondate]';
...
Classroom:   [classroom]
';
$string['setting:defaultrequestsubjectdefault'] = 'Course booking request: [iltname], [starttime]-[finishtime]';
...
$string['setting:defaultwaitlistedsubjectdefault'] = 'Waitlisting advice for [iltname]';
...
$string['setting:sessionroles'] = 'Users assigned to the selected roles in a course can be tracked with each ILT session';
...
$string['signupforthissession'] = 'Sign-up for this ILT session';
...
$string['upcomingsessionslist'] = 'List of all upcoming sessions for this ILT activity';
$string['updaterequests'] = 'Update requests';
$string['upgradeprocessinggrades'] = 'Processing ILT grades, this may take a while if there are many sessions...';
...
// Help Text.
$string['allowoverbook_help'] = 'When "Allow overbooking" is checked, learners will be able to sign up for a ILT session even if it is already full.<br />
...
$string['approvalreqd_help'] = 'When "Approval required" is checked, a learner will need approval from their manager to be permitted to attend a ILT session.';

$string['cancellationinstrmngr'] = '# Notice for manager';
$string['cancellationinstrmngr_help'] = 'When **Send notice to manager** is checked, the text in the **Notice for manager** field is sent to a learner\'s manager advising that they have cancelled a ILT booking.';
...
$string['confirmationinstrmngr_help'] = 'When "Send notice to manager" is checked, the text in the "Notice for manager" field is sent to a manager advising that a staff member has signed up for a ILT session.';

$string['confirmationmessage_help'] = 'This message is sent out whenever users sign up for a session.';

$string['description_help'] = '**Description** is the course description that displays when a learner enrols on a ILT session.
...
$string['emailmanagercancellation_help'] = 'When "Send notice to manager" is checked, an email will be sent to the learner\'s manager advising them that the ILT booking has been cancelled.';

$string['emailmanagerconfirmation'] = '# Send notice to manager';
$string['emailmanagerconfirmation_help'] = 'When "Send notice to manager" is checked, a confirmation email will be sent to the learner\'s manager when the learner signs up for a ILT session.';

$string['emailmanagerreminder'] = '# Send notice to manager';
$string['emailmanagerreminder_help'] = 'When "Send notice to manager" is checked, a reminder message will be sent to the learner\'s manager a few days before the start date of the ILT session.';
...
$string['modulename_help'] = 'The ILT activity module enables a teacher to set up a voluntary booking system for one or many in-person/classroom based sessions.

Each session within a ILT activity can have customised settings around location, venue, start time, finish time, cost, capacity, etc. These can be set to run over multiple days or to allow for unscheduled and waitlisted sessions.
...
$string['mods_help'] = 'ILT activities are used to keep track of in-person trainings which require advance booking.
...
$string['reminderinstrmngr_help'] = 'When **Send notice to manager** is checked, the text in the **Notice for Manager** field is sent to a learner\'s manager advising that they have signed up for a ILT session.';
...
The **Request message** section displays the notices sent to the learner and their manager regarding the approval process for the learner to attend the ILT session.

**Subject:** is the subject line that appears on the request approval emails sent to the manager and the learner.

**Message:** is the email text sent to the learner advising them that their request to attend the ILT session has been sent to their manager for approval.

**Notice for manager:** is the email text sent to the learner\'s manager requesting approval to attend the ILT session.';
...
* The staff member and the staff member\'s manager will be sent a confirmation email (i.e., the one formatted per the "Confirmation message" section of the ILT instance\'s settings).
* The staff member will be sent a reminder email message (i.e., the one formatted per the "Reminder message" section of the ILT instance\'s settings). The reminder will be sent a number of days before the session, according to the "Days before message is sent" setting also found in the "Reminder message" section of the ILT instance\'s settings.
...
* The staff member will be sent a confirmation email (i.e. the one formatted per the "Wait-listed message" section of the ILT instance\'s settings).
...
$string['sessionsoncoursepage_help'] = 'This is the number of sessions for each ILT activity that will be shown on the main course page.';
...
$string['showoncalendar_help'] = 'When **Site** is selected the ILT activity sessions will be displayed on the site calendar as a Global Event.  All site users will be able to view these sessions.

When **Course** is selected all of the ILT activity sessions will be displayed on the course calendar and as Course Event on the site level calendar and visible to all users enrolled in the course.

When **None** is selected, ILT activity sessions will only be displayed as User Events on a confirmed attendee\'s calendar, provided the **Show on user\'s calendar** option has been selected.';

$string['suppressemail_help'] = 'Use this option if you want to silently add/remove users from a ILT session. When this option is toggled, the usual email
...
$string['usercalentry_help'] = 'When active this setting adds a User Event entry to the calendar of an attendee of a ILT session. When turned off this prevents a duplicate event appearing in a session attendee\'s calendar, where you have calendar display settings set to Course or Site.';
...
$string['eventcourseILTviewed'] = 'Course ILT instances viewed';
$string['eventcoursemoduleviewed'] = 'ILT module instance viewed';
...
$string['alreadyenrolled'] = ' already enrolled to another session';
$string['capacityover'] = ' Enrolment Capacity Over';
$string['ecommerce_status_available'] = 'DATA AVAILABLE';
$string['ecommerce_status_notavailable'] = 'NO DATA AVAILABLE';
$string['ecommerce_status_enroll'] = 'ENROLL SUCCESSFULLY';
$string['ecommerce_status_notenroll'] = 'NOT ENROLLED';
