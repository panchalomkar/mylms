...
class mod_ilt_cancelsignup_form extends moodleform {

    public function definition() {
        $mform =& $this->_form;

        $mform->addElement('header', 'general', get_string('cancelbooking', 'ilt'));
        ...
        $mform->addElement('html', get_string('cancellationconfirm', 'ilt')); // Instructions.

        $mform->addElement('text', 'cancelreason', get_string('cancelreason', 'ilt'), 'size="60" maxlength="255"');
