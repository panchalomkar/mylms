...
var first_path =results[1].split('&');
var context_id =results[2].split('&');
var modpath_id =results[3].split('&');
var file_name =results[4].split('&');
var file_modpath_id =modpath_id[0].split('/');
var final_modpath_done = file_modpath_id[1]+'/'+file_modpath_id[2]+'/'+file_modpath_id[3];
var url = first_path[0]+'/'+context_id[0]+'/'+final_modpath_done+'/'+file_name;
//alert(url);
console.log(url);
var DEFAULT_URL = url;
