...
$enrolled_courses= count(getCourseEnrolledCount($USER->id));
 $total_courses = $DB->get_record_sql('SELECT count(id) as total_course FROM {course}');
...
?>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="card" style="height: 8rem;background-color: #0066b2; color:#fff;">
                                <div class="card-body" style="margin-top:18px">
                                    <center>
                                        <h2 style="color:#fff;"><?php echo $enrolled_courses;?></h2>
                                        <h6 style="color:#fff;">Enrolled Courses</h6>
                                    </center>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-6">
                            <div class="card"  style="height: 8rem;background-color: #fdbd10; color:#fff;">
                                <div class="card-body" style="margin-top:18px">
                                    <center>
                                        <h2 style="color:#fff;"><?php echo $total_courses->total_course ;?></h2>
                                        <h6 style="color:#fff;">Total Courses</h6>
                                    </center>
                                </div>
                            </div>
                        </div>
    ...
    <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade show active" id="today" role="tabpanel" aria-labelledby="today-tab">
                                ...
                                $sessionList = getchildliveClasses($USER->id,"today");
