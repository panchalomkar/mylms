...
$PAGE->set_title('My Team Course Wise Report');
$PAGE->set_heading('My Team Course Wise Report');

echo $OUTPUT->header();

$userid = optional_param('uid', 0, PARAM_INT);

$data = get_my_team_data($USER->id);
?>
<!DOCTYPE html>
...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">My Team Course Wise Report</h3>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title font-weight-bold">Course Status</h5>
