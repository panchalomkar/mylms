 ...
 * It includes methods to create chat completions.
 *
 ...
 */
class openai_chat extends openai_client {
     ...
     */
    public function create_completion(array $data): array {
        return $this->client('/chat/completions', 'POST', $data);
    }
