...
global $CFG;
$string['pluginname'] = 'GreenLMS Homepage Builder';
...
if (is_remuihomepage_req_plugin_available('theme_remui')) {
    ...
    if ((version_compare($themerelease, $pluginversions[$pluginseries]) > 0) && $themeversion > 2023053003) {
        ...
        $msg = 'Please Update the RapLMS theme and GreenLMS Page builder plugin before migrate';
    }
}
...
<span class="deprication-tooltiptext p-px-5 p-py-4  flex-column flex-gap-1 ">
    ...
    <div class="text-left secondary-text para-regular-1">
        We have introduced the improve LMS GreenLMS Page Builder to create Homepages. We Recommend you to migrate your existing Homepage to the new page builder or create a new homepage on the RapLMS Page Builder.
    </div>
