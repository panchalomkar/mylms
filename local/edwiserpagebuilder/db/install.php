...
function xmldb_local_edwiserpagebuilder_install() {
    ...
    // If edwiserpagebuilder is going to install first time and remuiblck is available in moodle site then this will help to moove table of "to do list" data to edwiserpagebuilder
