...
Vvveb.ComponentsGroup['Widgets'] = ["widgets/googlemaps",
 "widgets/embed-video",
//  "widgets/chartjs",
...
Vvveb.Components.extend("_base", "widgets/googlemaps", {
    ...
    html: '<div data-component-maps style="height: 400px; width: 100%; padding: 10px;"><iframe frameborder="0" src="https://maps.google.com/maps?q=Bucharest&z=15&t=q&key=&output=embed" width="100%" height="100%" style="width:100%;height:100%;left:0px"></iframe></div>',
