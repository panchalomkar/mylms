                ...
                <div class="image-flip">
                    <div class="mainflip flip-0">
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="https://source.unsplash.com/9UVmlIb0wJU/500x500" alt="card image"></p>
...
<style>
body:not(.block-content) .team {
    background: #eee !important;
}

body:not(.block-content) .team .btn-primary:hover,
body:not(.block-content) .team .btn-primary:focus {
...
body:not(.block-content) .team .image-flip:hover .backside,
body:not(.block-content) .team .image-flip.hover .backside {
...
body:not(.block-content) .team .image-flip:hover .frontside,
body:not(.block-content) .team .image-flip.hover .frontside {
...
body:not(.block-content) .team .mainflip {
...
body:not(.block-content) .team .frontside {
    position: relative;
    -webkit-transform: rotateY(0deg);
    -ms-transform: rotateY(0deg);
    z-index: 2;
...
body:not(.block-content) .team .backside {
    position: absolute;
    top: 0;
    left: 0;
    background: white;
