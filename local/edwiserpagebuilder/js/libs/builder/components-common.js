...
var FlexProperties = {
    ...
    },
    {
        ...
        inline:false,
        inputtype: SelectInput,
        validValues: ["start","center","end","space-between", "space-around","space-evenly","flex-end","flex-start","stretch"],
        data: {
            options: [{
                value: "start",
                text: "start"
...
Vvveb.Components.extend("_base", "_base", FlexProperties);
//Typography
...
var ComponentDeviceVisibility = {
	...
	// },
    {
        name: "Small devices (max-width: 576px)",
        key: "hidesm",
        col:12,
		inline:true,
		sort: base_sort++,
        ...
        name: "Medium devices (min-width: 577px and max-width: 768px)",
        key: "hidemd",
        col:12,
		inline:true,
		sort: base_sort++,
		section: advanced_section,
        htmlAttr: "class",
        validValues: ["edw-md-none", "hidden-md"],
        inputtype: ToggleInput,
        data: {
            on: "edw-md-none",
            off: ""
        ...
        name: "Large devices (min-width: 769px and max-width: 992px)",
        key: "hidelg",
        col:12,
		inline:true,
		sort: base_sort++,
        ...
        name: "Xl devices (min-width: 993px and max-width: 1200px)",
        key: "hidexl",
        col:12,
		inline:true,
		sort: base_sort++,
        ...
        name: "Xxl devices (min-width: 1201px and above)",
        key: "hidexxl",
        col:12,
		inline:true,
		sort: base_sort++,
