...
class license {
    ...
    public $wdmedwiserreportsdata = array (
        ...
        'plugin_short_name' => 'Reports & Analytics',
    ...
    public function activate_license() {
        ...
        if ($licensekey) {
            ...
            if ($this->check_if_no_data($licensedata, $currentresponsecode, $validresponsecode)) {
                $this->set_transient('failed', $licensedata);
                return;
            }
    ...
    public function get_data_from_db() {
        ...
        if ($gettrans) {
            ...
            if (is_array($gettrans) && $gettrans[1] > 0 && $gettrans[1] <= time()) {
                $transexpired = true;
        ...
        if ($transexpired == true) {
            ...
            if ($licensekey) {
                ...
                $this->set_response_data($licensestatus);
     ...
     * @param string  $licensestatus License status
     */
    public function set_response_data($licensestatus) {
        switch ($licensestatus) {
            case 'valid':
            case 'expired':
