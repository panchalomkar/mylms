...
class field_form extends moodleform {
    ...
    public function definition () {
        ...
        require_once($CFG->dirroot.'/local/properties/coursefield/'.$datatype.'/define.class.php');
        $newfield = 'course_define_'.$datatype;
        ...
        $mform->addElement('hidden', 'action', 'editcoursefield');
