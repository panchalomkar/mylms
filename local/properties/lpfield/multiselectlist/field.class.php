...
class lp_field_multiselectlist extends lp_profile_field_base {
    var $options;
    var $datakey;
     ...
     */
    function lp_field_multiselectlist($fieldid=0, $cohortid=0) {
        //first call parent constructor
        $this->lp_profile_field_base($fieldid, $cohortid);
