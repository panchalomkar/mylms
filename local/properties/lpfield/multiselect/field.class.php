...
class lp_field_multiselect extends lp_profile_field_base {
    var $options;
    var $datakey;
     ...
     */
    function lp_field_multiselect($fieldid=0, $userid=0) {
    ...
    function edit_field_add($mform) {
        ...
        $mform->addElement('select', $this->inputname, format_string($this->field->name), $this->options,array('class'=>'chosen'));
    ...
    function edit_field_set_default($mform) {
        ...
        if(!empty($defaultkey)){
            ...
            $mform->setDefault($this->inputname, $this->datakey);
        }
    }
