...
class field_form extends moodleform {
    ...
    public function definition () {
        ...
        require_once($CFG->dirroot.'/local/properties/cohortfield/'.$datatype.'/define.class.php');
        $newfield = 'cohort_define_'.$datatype;
        ...
        $mform->addElement('hidden', 'action', 'editcohortfield');
