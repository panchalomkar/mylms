...
class category_form extends moodleform {
    ...
    public function definition () {
        ...
        $mform->addElement('hidden', 'action', 'editcoursecategory');
        $mform->setType('action', PARAM_ALPHANUMEXT);

        $mform->addElement('text', 'name', get_string('coursecategoryname', 'local_properties'), 'maxlength="255" size="30"');
    ...
    public function validation($data, $files) {
        ...
        if ($dupfound ) {
            $errors['name'] = get_string('coursecategorynamenotunique', 'local_properties');
        }
