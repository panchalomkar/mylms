 ...
 * Menu profile field.
 *
 * @package    profilefield_certificate
 * @copyright  2007 onwards Shane Elliot {@link http://pukunui.com}
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

/**
 * Class profile_field_certificate
 *
 * @copyright  2007 onwards Shane Elliot {@link http://pukunui.com}
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class cohort_field_certificate extends cohort_profile_field_base {
     ...
     * @param int $userid
     */
    public function profile_field_certificate($fieldid = 0, $userid = 0) {
        global $COURSE ;

        // First call parent constructor.
        $this->cohort_profile_field_base($fieldid, $userid);
        ...
        foreach ($modules as $key => $value) {
            if($value->modname == 'certificate')
            {   
                $certificates[$value->instance] =$value->name ;   
            }
        }
        ...
        foreach ($certificates as $key => $certificate) {
            $this->options[$key] = format_string($certificate); // Multilang formatting.
        }
