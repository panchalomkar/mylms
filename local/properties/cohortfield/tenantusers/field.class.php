...
class cohort_field_tenantusers extends cohort_profile_field_base
{
     ...
     */
    function cohort_field_tenantusers($fieldid = 0, $userid = 0)
    {
    ...
    {
        $mform->addElement('select', $this->inputname, format_string($this->field->name), $this->options, array(
            'class' => 'chosen' 
        ));
