...
class cohort_field_multiselectlist extends cohort_profile_field_base {
    var $options;
    var $datakey;
     ...
     */
    function cohort_field_multiselectlist($fieldid=0, $cohortid=0) {
        //first call parent constructor
        $this->cohort_profile_field_base($fieldid, $cohortid);
