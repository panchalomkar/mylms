...
class course_field_multiselectlist extends course_field_base {
    var $options;
    var $datakey;
     ...
     */
    function course_field_multiselectlist($fieldid=0, $courseid=0) {
        //first call parent constructor
        $this->course_field_base($fieldid, $courseid);
