 ...
 */
class mt_cohort_candidate_selector extends user_selector_base {
    protected $cohortid;
    ...
    public function find_users($search) {
        ...
        $sql = " FROM {user} u left join {company_users} cu ON u.id = cu.userid 
            LEFT JOIN {cohort_members} cm ON (cm.userid = u.id AND cm.cohortid = :cohortid)
                WHERE cm.id IS NULL AND cu.companyid = $companyid and  $wherecondition";
    ...
    protected function get_options() {
        ...
        $options['file'] = 'local/mt_dashboard/cohort/locallib.php';
        return $options;
    }
}
/**
 * Cohort assignment candidates
 */
class mt_cohort_existing_selector extends user_selector_base {
    protected $cohortid;
