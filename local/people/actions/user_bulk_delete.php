...
if ($confirm and confirm_sesskey()) {
    ...
    if (!empty($notifications)) {
        ...
        if(count($userlist)>1){
            echo $OUTPUT->notification(get_string('deleteconfirm1','local_people',$usernames), 'notifysuccess');
        }else{
            echo $OUTPUT->notification(get_string('deleteconfirm','local_people',$usernames), 'notifysuccess');
        }  
    }
