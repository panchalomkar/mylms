...
class raplms_curl
{
    ...
    public function __construct($options = array())
    {
        ...
        {
            if(class_exists('raplms_curlcache'))
            {
                $this->cache = new raplms_curlcache();
            }
        }
    }
    ...
    /*
     * Mulit HTTP Requests This function could run multi-requests in parallel. @param array $requests An array of files to request @param array $options An array of options to set @return array An array of results
     */
